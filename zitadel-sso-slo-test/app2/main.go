...
var oauth2Config = &oauth2.Config{
	ClientID:     "290577771535532035",                                               // Replace with your App2 Client ID
	ClientSecret: "WibqwbjBS2g6JZpqE55b01cHerrPTfYu5Hhlftkegx687rUuYcMnqILrwXchCRIn", // Replace with your App2 Client Secret
...
func main() {
	...
	fmt.Println("App2 is running on http://localhost:3002")
...
func homeHandler(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintln(w, `<a href="/login">Login with ZITADEL (App2)</a>`)
}
...
func logoutHandler(w http.ResponseWriter, r *http.Request) {
	http.Redirect(w, r, "http://localhost:8080/oidc/v1/end_session?post_logout_redirect_uri=http://localhost:3002", http.StatusTemporaryRedirect)
}
